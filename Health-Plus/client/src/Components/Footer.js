...
function Footer() {
  return (
    <div className="footer-section">
      <img className="footerbgimg" src={require("../Assets/Heart Beat Wallpaper.jpg")}/>
      ...
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthplus.com">care@hospitalguru.com</a>
            </li>
            <li>
              <a href="mailto:appointment@healthplus.com">
                appointment@hospitalguru.com
              </a>
            </li>
            <li>
              <a href="tel:+91- 9971838199">+91- 9971838199</a>
            </li>
